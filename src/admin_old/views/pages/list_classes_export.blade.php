...
@section('body')
    <main id="main">
			...
			<span class="toolbar-left">
				<div class="toolbar-right">
                    <div class="save-block">
                        <a href="/admin/list_class_import" class="btn clr-secondary"><span class="btn-text">{{__('editora_lang::messages.file_import')}}</span></a>
                    </div>
                </div>
			</span>--}}
        </div>
        <section class="table-view-header">
            <div class="container">
				<span class="data">
					<h3 class="tit">{{__('editora_lang::messages.list_classes_to_export')}}</h3>
				</span>
        ...
        <section class="">
            <div class="container">
                ...
                <p>{!! $message !!}</p>
                <br>
                <p>{!! $count_rows !!} {{__('editora_lang::messages.inserted_elements')}}</p>
                <br><br>
            </div>
        </section>
        @endif
        ...
        <section class="table-view">
            <div class="container">
                <table class="table" id="classes-table">
                    <thead>
                    <tr>
                        <th class="tit"><span>{{__('editora_lang::messages.info_word_ID')}}</span></th>
                        <th class="tit"><span>{{__('editora_lang::messages.info_word_type')}}</span></th>
                        <th class="favorite">{{__('editora_lang::messages.export')}}</th>
                    </tr>
                    </thead>
                    <tbody>
