    ...
    <div class="column column-text">
        <div class="form-group">
            ...
            <div class="input-group">
                <input type="text" class="form-control" name="{{$attribute_name}}" value="{{$attribute['niceurl']}}" disabled="disabled">
...
@elseif($p_mode=='U' || $p_mode=='I')
    <div class="column column-text">
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="{{$attribute_name}}" value="{{$attribute['niceurl']}}">
        </div>
    </div>
@endif