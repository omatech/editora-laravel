<div id="modifications-menu">
    <header class="side-menu-header">
        <span class="tit">{{ __('editora_lang::messages.info_word_last_modifications') }}</span>
        <button class="btn-square clr-gray" id="btn-hide-modifications"><i class="icon-close"></i><span class="sr-only">{{ __('editora_lang::messages.info_word_close_last_modifications') }}</span></button>
    </header>
