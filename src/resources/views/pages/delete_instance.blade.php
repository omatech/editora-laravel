...
<main id="main">
	<section class="table-view-header">
		<div class="container">
			<span class="data">
				<h3 class="tit">{{__('editora_lang::messages.info_word_delete_instance')}}</h3>
			</span>
		</div>
	</section>
	...
	<section class="table-view">
		<div class="container">
			...
			<h3 class="tit">{{__('editora_lang::messages.delete_not_possible')}} <a href="{{ route('editora.action', 'view_instance/?p_pagina=1&p_class_id='.$params['param1'].'&p_inst_id='.$params['param2']) }}">{{__('editora_lang::messages.navigation_back')}}</a></h3>
			<h3 class="tit">{{__('editora_lang::messages.related_objects')}}</h3>
    ...
    @else
		<div class="container">
			<span class="data">
				<h2 class="tit">{{__('editora_lang::messages.info_word_areyousure')}} <a href="{{route('editora.action', 'delete_instance2/?p_pagina=1&p_class_id='.$params['param1'].'&p_inst_id='.$params['param2'])}}">{{__('editora_lang::messages.info_word_yes')}}</a> <a href="{{route('editora.action', 'view_instance/?p_pagina=1&p_class_id='.$params['param1'].'&p_inst_id='.$params['param2'])}}">{{__('editora_lang::messages.info_word_no')}}</a></h2>
			</span>
		</div>
	@endif
</main>
