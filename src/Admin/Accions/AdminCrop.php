...
// require_once(DIR_APLI_ADMIN.'/Util/upload_class.php');
...
if (isset($_REQUEST['p_width'])) {
    $upload->set("p_width", $_REQUEST['p_width']);
} else {
    $upload->set("p_width", $_REQUEST['width']);
}
if (isset($_REQUEST['p_height'])) {
    $upload->set("p_height", $_REQUEST['p_height']);
} else {
    $upload->set("p_height", $_REQUEST['height']);
}
