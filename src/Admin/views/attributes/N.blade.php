...
@if($p_mode=='V')
    <div class="column column-text">
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="{{$attribute_name}}" value="@isset($attribute['atrib_values'][0]){{$attribute['atrib_values'][0]['num_val']}}@endisset" disabled="disabled">
        </div>
    </div>
