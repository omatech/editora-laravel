...
@if($p_mode=='V')
    <div class="column column-text">
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="{{$attribute_name}}" value="{{$attribute['atrib_values'][0]['text_val']}}" disabled="disabled" style="background-color:{{$attribute['atrib_values'][0]['text_val']}}">
        </div>
    </div>
@elseif($p_mode=='U' || $p_mode=='I')
    <div class="column column-text">
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="{{$attribute_name}}" name="{{$attribute_name}}" value="{{$attribute['atrib_values'][0]['text_val']}}">
        </div>
    </div>
@section('scripts')
    @parent
