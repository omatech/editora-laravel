@if($p_mode=='V')
    <div class="column">
        <div class="form-group">
            ...
            <textarea name="{{$attribute_name}}" class="form-control" disabled>{{$attribute['atrib_values'][0]['json_val']}}</textarea>
        </div>
    </div>
@elseif($p_mode=='U' || $p_mode=='I')
    <div class="column">
        <div class="form-group">
            ...
            <textarea name="{{$attribute_name}}" class="form-control">{{$attribute['atrib_values'][0]['json_val']}}</textarea>
        </div>
    </div>
@endif
