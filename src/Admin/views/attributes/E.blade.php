...
@if($p_mode=='V')
    <div class="column column-text">
        <div class="form-group">
            ...
            <input type="text" name="{{$attribute_name}}" class="form-control" value="@isset($attribute['atrib_values'][0]) {{$attribute['atrib_values'][0]['date_val']}}@endisset" disabled="disabled">
        </div>
    </div>
